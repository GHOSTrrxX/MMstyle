                ...
                <table className="w-full text-left">
                    <thead>
                        <tr className="bg-black text-gray-400 text-xs uppercase tracking-wider">
                            ...
                            <th className="p-4 text-center">Comissão Padrão</th>
                    ...
                    <tbody className="divide-y divide-gray-800">
                        {loading ? (
                            ...
                            services.map((service) => (
                                <tr key={service.id} className="hover:bg-black/30 transition-colors">
                                    <td className="p-4 text-white font-medium">{service.name}</td>
                                    <td className="p-4 text-center text-gold-500 font-bold">{service.commission_percentage}%</td>
